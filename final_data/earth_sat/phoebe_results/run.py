...
roman_errs = [10e-6, 20e-6] #micro-as
...
n_planets = 2
run_number = 3
for run_sub_number in range(11, 11):
						...
						for the_err in the_errs:
							for gaia_err in gaia_errs:
								if __name__ == "__main__":
									...
									print('run number: ' + str(run_number)+'.'+str(run_sub_number))
									print('start')
									print('--------')
...
run_number=7
for run_sub_number in range(6, 11):
	for input_param in input_params:
		for inclination in inclinations:
			for roman_err in roman_errs:
				for roman_duration in roman_durations:
